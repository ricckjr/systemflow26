-- REBUILD CHAT NOTIFICATIONS TABLE
-- This script fixes the missing table error by recreating it and its triggers.
...
DECLARE
  recipient_id uuid;
BEGIN
  -- Optimized: Insert for all recipients in one go
