...
const InfoBox: React.FC<Props> = ({ label, value, icon: Icon, isHighlight }) => (
  <div className={`p-6 rounded-[1.5rem] border flex items-center gap-5 transition-all group ${isHighlight ? 'bg-brand-600 border-brand-500 shadow-brand-600/20 scale-105 z-10' : 'bg-surface border-line'}`}>
