          ...
          {loading ? (
            ...
            <div className="overflow-hidden rounded-2xl border border-white/5">
              <div className="grid grid-cols-12 gap-3 px-4 py-3 bg-white/5 border-b border-white/5">
                ...
                <div className="col-span-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Ordem</div>
                <div className="col-span-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Cor</div>
                <div className="col-span-2 text-[10px] font-black uppercase tracking-widest text-slate-400">Observação</div>
                  ...
                  .map((i) => (
                    <div key={i.id} className="grid grid-cols-12 gap-3 px-4 py-3 bg-[#0B1220]/60 hover:bg-[#0B1220] transition-colors">
                      ...
                      <div className="col-span-2 min-w-0">
                        <div className="text-sm text-slate-300 truncate">{i.ordem}</div>
                      </div>
                      <div className="col-span-2 min-w-0 flex items-center gap-2">
                        ...
                        />
                        <div className="text-xs text-slate-300 font-mono truncate">{i.cor || '-'}</div>
                      </div>
                      <div className="col-span-2 min-w-0">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-300 uppercase tracking-wide ml-1">Ordem (0 = automático)</label>
              <input
                value={draftOrdem}
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-300 uppercase tracking-wide ml-1">Cor (hex)</label>
              <div className="flex items-center gap-2">
                <input
                  type="color"
                  value={normalizeHex(draftCor) || '#94a3b8'}
                  onChange={(e) => setDraftCor(e.target.value)}
                  className="h-12 w-14 rounded-xl bg-[#0B1220] border border-white/10 px-2"
                />
                <input
                  value={draftCor}
                  onChange={(e) => setDraftCor(e.target.value)}
