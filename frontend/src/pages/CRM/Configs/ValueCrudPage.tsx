    ...
    <div className="space-y-5">
          ...
          {loading ? (
            ...
            <div className="overflow-hidden rounded-2xl border border-[var(--border)]">
              <div className="grid grid-cols-12 gap-3 px-4 py-3 bg-[var(--bg-card)] border-b border-[var(--border)]">
                ...
                <div className="col-span-2 text-xs font-black uppercase tracking-widest text-[var(--text-muted)]">Valor</div>
                <div className="col-span-3 text-xs font-black uppercase tracking-widest text-[var(--text-muted)]">Observação</div>
                ...
                {filtered.map((i) => (
                  <div key={i.id} className="grid grid-cols-12 gap-3 px-4 py-3 bg-[var(--bg-main)]/60 hover:bg-[var(--bg-main)] transition-colors">
                    ...
                    <div className="col-span-2 min-w-0">
                      <div className="text-sm text-[var(--text-soft)] truncate">{formatCurrency(i.valor)}</div>
                    </div>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-[var(--text-soft)] uppercase tracking-wide ml-1">Valor (R$)</label>
            <input
              value={draftValor}
