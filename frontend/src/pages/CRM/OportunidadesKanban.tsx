    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-semibold text-slate-100">Cadastrar Oportunidades (Kanban)</h1>
          <p className="text-sm text-slate-400 mt-1">
            Visualização em Kanban para organizar oportunidades por etapa.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-slate-400">
              Vamos adicionar o Kanban do CRM aqui, reutilizando o padrão de arrastar/soltar do sistema.
            </p>
          </div>
        </div>
      </Card>
