...
export const CodeCrudPage: React.FC<CodeCrudPageProps> = ({ title, subtitle, singularLabel, fetchItems, createItem, updateItem, deleteItem }) => {
      ...
      {loading ? (
        ...
        <div className="overflow-hidden rounded-2xl border border-white/5">
          <div className="grid grid-cols-12 gap-3 px-4 py-3 bg-white/5 border-b border-white/5">
            <div className="col-span-4 text-[10px] font-black uppercase tracking-widest text-slate-400">Código</div>
            <div className="col-span-7 text-[10px] font-black uppercase tracking-widest text-slate-400">Descrição</div>
