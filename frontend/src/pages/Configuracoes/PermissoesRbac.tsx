          ...
          {perfis.map(p => (
            ...
            >
              ...
              <button
                ...
                className="p-2 rounded-lg text-[var(--text-muted)] hover:text-rose-400 hover:bg-rose-500/10 disabled:opacity-50 disabled:hover:bg-transparent"
        ...
        <div className="mt-4 pt-4 border-t border-industrial-border">
          ...
          <div className="space-y-2">
            <input
              ...
              className="w-full h-10 bg-industrial-bg border border-industrial-border rounded-xl px-3 text-white placeholder:text-[var(--text-soft)] focus:border-[var(--primary)] focus:ring-1 focus:ring-[var(--primary)] outline-none"
            />
            <input
            ...
            <button
              ...
              className="w-full h-10 rounded-xl bg-[var(--primary)] hover:bg-[var(--primary-600)] text-[#0B0F14] font-bold flex items-center justify-center gap-2 disabled:opacity-60"
            >
          ...
          <div className="mb-4 rounded-2xl border border-industrial-border bg-industrial-bg/20 p-4">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="sm:col-span-1">
                <div className="text-xs font-bold text-industrial-text-secondary uppercase mb-1">Nome</div>
                <input
              ...
              <div className="sm:col-span-2">
                <div className="text-xs font-bold text-industrial-text-secondary uppercase mb-1">Descrição</div>
                <input
              ...
              <div className="sm:col-span-3 flex items-center justify-between gap-3 pt-1">
                ...
                <button
                  ...
                  className="h-10 px-4 rounded-xl bg-[var(--bg-card)] hover:bg-[var(--bg-card)] text-white font-bold text-xs disabled:opacity-60"
                >
