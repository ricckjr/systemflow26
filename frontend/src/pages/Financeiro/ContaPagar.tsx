    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-semibold text-[var(--text-main)]">Conta a Pagar</h1>
          <p className="text-sm text-[var(--text-muted)] mt-1">Gestão de pagamentos e obrigações.</p>
        </div>
      ...
      <Card>
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-[var(--text-muted)]">Aqui você vai gerenciar contas a pagar, vencimentos e status.</p>
          </div>
        </div>
      </Card>
    </div>
