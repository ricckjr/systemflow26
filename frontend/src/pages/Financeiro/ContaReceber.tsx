    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-semibold text-slate-100">Conta a Receber</h1>
          <p className="text-sm text-slate-400 mt-1">Gestão de títulos e recebimentos.</p>
        </div>
      ...
      <Card>
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-slate-400">Aqui você vai gerenciar contas a receber, cobranças e status.</p>
          </div>
        </div>
      </Card>
    </div>
