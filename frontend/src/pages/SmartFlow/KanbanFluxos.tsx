...
export default function KanbanFluxos() {
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-semibold text-[var(--text-main)]">Kanban de Fluxos</h1>
          <p className="text-sm text-[var(--text-muted)] mt-1">
            Organização visual dos fluxos e atendimentos.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-[var(--text-muted)]">
              Aqui vamos adicionar um Kanban para acompanhar fluxos e estágios.
            </p>
          </div>
        </div>
      </Card>
