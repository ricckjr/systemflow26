    ...
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl font-semibold text-[var(--text-main)]">Manuais</h1>
          <p className="text-sm text-[var(--text-muted)] mt-1">
            Documentação e guias para o dia a dia.
          </p>
        </div>
        <div className="shrink-0 inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[var(--border)] bg-[var(--bg-card)] text-xs text-[var(--text-soft)]">
          <BookOpenText size={14} className="text-[var(--primary)]" />
          Universidade
        </div>
      </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-[var(--text-muted)]">
              Aqui vamos publicar manuais internos, processos e boas práticas.
            </p>
          </div>
        </div>
      </Card>
